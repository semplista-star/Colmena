...
const INTEGRATIONS: { name: string; agents: string; vars: string[]; whatItUnlocks: string }[] = [
  ...
  { name: "Agenda (Cal.com)", agents: "AG-10", vars: ["CALCOM_BOOKING_URL"], whatItUnlocks: "El lead recibe tu enlace de reserva." },
  { name: "Confirmación de reservas (Cal.com)", agents: "AG-10", vars: ["CALCOM_WEBHOOK_SECRET"], whatItUnlocks: "El lead pasa a \"reunión\" en cuanto reserva." },
